...
import com.example.BasicBankingSystem.database.UserHelper;
import com.example.BasicBankingSystem.data.User;
import com.example.BasicBankingSystem.adapters.SendToUserAdapter;
import com.example.BasicBankingSystem.R;
import com.example.BasicBankingSystem.database.TransactionParams.TransactionEntry;
        ...
        builder_exitButton.setTitle("Do you want to cancel the transaction?").setCancelable(false)
                .setPositiveButton ("yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick (DialogInterface dialogInterface, int i) {
                        ...
                        startActivity(new Intent(SendToUserList.this, AllUsersList.class));
                        finish();
                    }
